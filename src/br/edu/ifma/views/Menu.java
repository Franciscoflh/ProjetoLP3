...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem5.setText("Ver Funcionário");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        CadastrarProduto panel2 = new CadastrarProduto();
        contane.removeAll();
        contane.add(panel2, BorderLayout.CENTER);
        contane.revalidate();
        contane.repaint();
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ListarProduto panel = new ListarProduto();
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        ...
        cadastro.setSize(495, 390);
        cadastro.setLocation(0, 0);
        contane.removeAll();
        contane.add(cadastro, BorderLayout.CENTER);
        contane.revalidate();
        contane.repaint();
